        ...
        return (
            ...
            >
                <Box sx={{
                    ...
                    <Typography variant="h6" style={{fontFamily: 'Tahoma, Arial, sans-serif', marginTop:'45px'}}>Are you sure you want to log out?</Typography>
        ...
        <div>
            <IconButton 
                ...
                sx={{
                    margin:1,
                    padding: '15px',
                    backgroundColor:'#fcf36a', 
                    '&:hover': {
                        backgroundColor: '#bde8b5', // Change background on hover
                    },
    ...
    {menuItem.map((item, index) => (
        <ListItem 
          ...
          sx={{
            padding: '10px', 
            '&:hover': {
                backgroundColor: '#f7e434', // Change background on hover
            },
            '& .MuiListItemIcon-root, & .MuiListItemText-root': {
                fontSize: '1.2rem',
            }
